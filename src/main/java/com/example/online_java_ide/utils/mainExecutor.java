...
public class mainExecutor {
    public static String execute(byte[] classByte, String systemIn) {
        ...
        byte[] modifyBytes = classModifier.modifyConstantUTF8Value("java/lang/System", "BOOT-INF/classes/com/example/online_java_ide/utils/CustomSystem");
//        System.out.println(System.getProperty("java.lang.System"));
        modifyBytes = classModifier.modifyConstantUTF8Value("java/util/Scanner", "BOOT-INF/classes/com/example/online_java_ide/utils/CustomScanner");
