...
public class mainExecutor {
    public static String execute(byte[] classByte, String systemIn) {
        ...
        byte[] modifyBytes = classModifier.modifyConstantUTF8Value("java/lang/System", "com/example/online_java_ide/utils/CustomInputStream");
        modifyBytes = classModifier.modifyConstantUTF8Value("java/io/Scanner", "com/example/online_java_ide/utils/CustomScanner");
